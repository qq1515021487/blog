...
$(document).ready(function() {
	$("#count").countdown({
		...
		htmlTemplate: "<div id='days-count' class='numbers'><span id='time_d'></span><span class='days-label'>days</span></div> <div id='hours-count' class='numbers'><span id='tiem_h'></span><span class='hours-label'>hours</span></div><div id='min-count' class='numbers'><span id='tiem_m'></span><span class='min-label'>min</span></div><div id='sec-count' class='numbers'><span id='tiem_s'></span><span class='sec-label'>sec</span></div>"
	});
});
